...
# state: under review
permalink: /publication/2026-02-01-Rc-BT
...
paperurl: 'https://openreview.net/forum?id=hKxYESOzen'
# citation: 'Cai Jianfeng. (2026). &quot;Disentangling Length Bias In Preference Learning Via Response-Conditioned Modeling.&quot; <i>arXiv preprint arXiv: 2602.00814, 2026</i>.'
---
...
[Download paper from here](https://openreview.net/forum?id=hKxYESOzen)
...
<pre>
@inproceedings{
anonymous2026disentangling,
title={Disentangling Length Bias in Preference Learning via Response-Conditioned Modeling},
author={Anonymous},
booktitle={The Fourteenth International Conference on Learning Representations},
year={2026},
url={https://openreview.net/forum?id=hKxYESOzen}
}
</pre>