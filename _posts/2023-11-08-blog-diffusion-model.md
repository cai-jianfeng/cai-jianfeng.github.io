...
& \Rightarrow \dfrac{x_t^2 - 2 \sqrt{\alpha_t}x_t{x_{t-1}}+\alpha_t{x_{t-1}^2}}{\beta_t} + \dfrac{{x_{t-1}^2} - 2\sqrt{\bar{\alpha}_{t-1}}x_0{x_{t-1}} + \bar{\alpha}_{t-1}x_0^2}{1 - \bar{\alpha}_{t-1}} - \dfrac{(x_t - \sqrt{\bar{\alpha}_t}x_0)^2}{1 - \bar{\alpha}_t} \\ 
