...
$$\begin{gathered} S=\operatorname{Softmax}\left(X \cdot W_g\right), \quad S \in \mathbb{R}^{n \times e} \\
G, I=\operatorname{TopK}\left(S^{\top}, k\right), P=\operatorname{Onehot}(I) \end{gathered}$$<span style="color: red">(补充：expert capacity + MoE FFN + Additional Constraint)</span></p>
