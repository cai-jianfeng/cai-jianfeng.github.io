...
5. [<p style="text-align:justify; text-justify:inter-ideograph;">Switch transformers: scaling to trillion parameter models with simple and efficient sparsity</p>](https://dl.acm.org/doi/abs/10.5555/3586589.3586709)
...
8. [<p style="text-align:justify; text-justify:inter-ideograph;">Mixture-of-Experts Meets Instruction Tuning:A Winning Combination for Large Language Models</p>](https://arxiv.org/abs/2305.14705)
