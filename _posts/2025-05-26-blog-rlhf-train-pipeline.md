...
<p style="text-align: justify; text-justify: inter-ideograph; word-break: break-all;">2. 第二阶段：完成 PPO 的生成阶段，便是 PPO 的训练阶段。可以发现，为了更好地利用 PPO 生成阶段所生成的结果，一般会使用其进行<a href="https://github.com/deepspeedai/DeepSpeedExamples/blob/bd47e5bc38d292f44bf183e7bda992cde36a769b/applications/DeepSpeed-Chat/training/step3_rlhf_finetuning/main.py#L550" target="_blank">多次训练</a>。对于<a href="https://github.com/deepspeedai/DeepSpeedExamples/blob/bd47e5bc38d292f44bf183e7bda992cde36a769b/applications/DeepSpeed-Chat/training/step3_rlhf_finetuning/main.py#L553" target="_blank">第 $t$ 次训练</a>，首先是根据 PPO 生成阶段的 $p_{RL}$，$p_{SFT}$ 和 $R$ 计算 <a href="https://github.com/deepspeedai/DeepSpeedExamples/blob/bd47e5bc38d292f44bf183e7bda992cde36a769b/applications/DeepSpeed-Chat/training/step3_rlhf_finetuning/main.py#L553" target="_blank">old_rewards</a> (这里可能会有些奇怪，在上述的<a href="RLHF pipeline">RLHF 的算法流程</a>中似乎没有这个流程，其实这里就是计算 <a href="https://github.com/deepspeedai/DeepSpeedExamples/blob/bd47e5bc38d292f44bf183e7bda992cde36a769b/applications/DeepSpeed-Chat/dschat/rlhf/ppo_trainer.py#L184" target="_blank">$KL$</a>，并将其融入到 <a href="https://github.com/deepspeedai/DeepSpeedExamples/blob/bd47e5bc38d292f44bf183e7bda992cde36a769b/applications/DeepSpeed-Chat/dschat/rlhf/ppo_trainer.py#L185-L192" target="_blank">$R$</a> 中进行后续的计算而已)。</p>接着便是标准的使用 <a href="https://nn.labml.ai/rl/ppo/gae.html" target="_blank">GAE</a> 生成 advantage <a href="https://github.com/deepspeedai/DeepSpeedExamples/blob/bd47e5bc38d292f44bf183e7bda992cde36a769b/applications/DeepSpeed-Chat/dschat/rlhf/ppo_trainer.py#L310-L318" target="_blank">$A$</a> 和 <a href="https://github.com/deepspeedai/DeepSpeedExamples/blob/bd47e5bc38d292f44bf183e7bda992cde36a769b/applications/DeepSpeed-Chat/dschat/rlhf/ppo_trainer.py#L319" target="_blank">return</a>。
